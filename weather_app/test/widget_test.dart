...
import 'package:weather_app/getLocation.dart'; // This should be the file where MyLocation is defined
import 'package:weather_app/weather.dart';     // This should be the file where Weather is defined
